...
const Developer = ({ animationName = 'idle', ...props }) => {
    ...
    const { nodes, materials, animations: gltfAnimations } = useGLTF('/models/animations/developer.glb');

    const idleAnimation = useFBX('/models/animations/idle.fbx');
    idleAnimation.animations[0].name = 'idle';

    const combinedAnimations = [...gltfAnimations, idleAnimation.animations[0]];
